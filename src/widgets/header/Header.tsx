    ...
    <header className="md:m-[31px_73px_0px] m-[15px_19px_0px] rounded-[13px] bg-white relative z-[100]">
      <menu className="flex items-center justify-between 2xl:p-[9px_74px] lg:p-[9px_50px] md:p-[9px_30px] p-[15px_13px] text-[15px] font-normal">
          ...
          <Link href={'/catalog'} onClick={handleLinkClick}>
            ...
            <div className="md:hidden block">
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  d="M15.1464 15.8536C15.3417 16.0488 15.6583 16.0488 15.8536 15.8536C16.0488 15.6583 16.0488 15.3417 15.8536 15.1464L15.1464 15.8536ZM15.8536 15.1464L12.3536 11.6464L11.6464 12.3536L15.1464 15.8536L15.8536 15.1464Z"
                  fill="#2D2B2D"
                />
              </svg>
            </div>
          </Link>
          <Link href={'/basket'} className="relative" onClick={handleLinkClick}>
            <div className="md:block hidden">
              <p>Корзина</p>
              {productsInBasket.length > 0 && (
                <div className="top-[2px] right-[-13px] rounded-full h-[6px] w-[6px] bg-purple absolute"></div>
              )}
            </div>
            <div className="md:hidden block">
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  d="M14.125 4.25L15.375 15.5H7.875"
                  stroke="#2D2B2D"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M10.706 4.02941C10.706 3.09335 10.4271 2.19563 9.93068 1.53374C9.43426 0.871848 8.76097 0.5 8.05892 0.5C7.35688 0.5 6.68359 0.871848 6.18717 1.53374C5.69075 2.19563 5.41187 3.09335 5.41187 4.02941"
                  stroke="#2D2B2D"
                  strokeLinecap="round"
                />
              </svg>
              {productsInBasket.length > 0 && (
                <div className="top-[-3px] right-[-5px] rounded-full h-[6px] w-[6px] bg-purple absolute"></div>
              )}
            </div>
          </Link>
        </nav>
        ...
        <nav className="flex items-center justify-end md:gap-[50px] gap-[26px]">
          ...
          <Link href={'/profile'} className="relative" onClick={handleLinkClick}>
            <div className="md:block hidden">
              <p>Профиль</p>
              {profile && (
                <div className="top-[2px] right-[-13px] rounded-full h-[6px] w-[6px] bg-purple absolute"></div>
            ...
            <div className="md:hidden block">
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  d="M5.50006 10L2.87354 15.6499H7.89028"
                  stroke="#2D2B2D"
                  strokeWidth="0.93808"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M10.3902 10L13.0167 15.6499H7.99998"
                  stroke="#2D2B2D"
                  strokeWidth="0.93808"
                  strokeLinecap="round"
                  strokeLinejoin="round"
