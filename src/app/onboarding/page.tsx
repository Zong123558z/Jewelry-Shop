...
const list = [
  '/images/onboarding/onboarding.png',
  '/images/onboarding/onboarding.png',
  '/images/onboarding/onboarding.png',
]
      ...
      >
              ...
              <div className="w-full text-black absolute bottom-[14.7vw] left-0">
                ...
                <div className="w-full p-[0px_16.2vw] flex items-center justify-center">
                  <button
                    ...
                    className={`transition-all active:scale-95 bg-purple w-full rounded-[8px] p-[2.7vw_0px] mt-[13.2vw]`}
                  >
        ...
        <div className="absolute top-0 left-0 z-30 w-full grid col-span-3 mt-[26px]">
          <button
            ...
            className={`ml-[24px] mt-[-8px] transition-all ${activeSlide === 0 ? 'opacity-0 pointer-events-none' : ''}`}
          >
