        ...
        <div className="">
          <div style={{ gridTemplateColumns: '1fr 6fr 1fr' }} className="grid">
            ...
            <div className="flex justify-end items-center">
              <button onClick={() => setIsOpen(false)} className="transition-all active:scale-[0.98] hover:scale-105">
                ...
                >
                  <path
                    d="M8.39209 8.47534L22.1613 22.2446"
                    stroke="#B3B3B3"
                    strokeWidth="1.52991"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M22.1611 8.47534L8.39192 22.2446"
                    stroke="#B3B3B3"
                    strokeWidth="1.52991"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <div className="md:mt-[21px] mt-[3.47vw] rounded-[23px] border border-[#ECECEC]">
            ...
            >
              ...
              <button
                onClick={onClick}
                className={`rounded-[8px] font-medium md:text-[20px] text-[4.27vw] text-white w-full bg-purple md:p-[19.7px_0px] p-[2.7vw_0px] flex items-center justify-center transition-all active:scale-[0.98] ${
