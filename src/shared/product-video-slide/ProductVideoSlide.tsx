...
export const ProductVideoSlide = ({ videoSrc }: IProps) => {
  ...
  return (
    <div className="w-full aspect-square overflow-hidden md:rounded-[35px] rounded-[0px] relative">
      <video ref={videoRef} src={videoSrc} className="object-cover w-full h-full absolute top-0 left-0" />
      <div onClick={handlePlayPause} className="w-full h-full absolute grid grid-rows-3">
        ...
        <div className={'flex items-center justify-center'}>
          <button className="bg-[#00000033] rounded-full md:w-[73px] w-60px md:h-[73px] h-60px cursor-pointer flex items-center justify-center">
            {isPlaying ? (
              <svg
                className="md:w-[23px] md:h-[38px] w-19px h-27px"
                width="23"
                height="38"
                viewBox="0 0 23 38"
                fill="none"
        ...
        <div className="w-full flex items-end">
          <div className="w-full flex justify-between items-center gap-[11px] md:mb-[54px] mb-[5vw] md:p-[0px_15px] p-[0px_24px]">
            ...
            <button onClick={handleFullscreen} className="transition-all active:scale-95 cursor-pointer">
              <svg
                className="md:w-[37px] md:h-[37px] w-31px h-31px"
                width="37"
                height="37"
                viewBox="0 0 37 37"
                fill="none"
              ...
              >
                <path
                  d="M15.8236 8.18787L10.8196 8.18787C9.77369 8.18787 8.92578 9.03578 8.92578 10.0817V15.0857"
                  stroke="#B3B3B3"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M15.8236 27.2775L10.8196 27.2775C9.77369 27.2775 8.92578 26.4296 8.92578 25.3836V20.3796"
                  stroke="#B3B3B3"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M21.3229 8.18787L26.3268 8.18787C27.3728 8.18787 28.2207 9.03578 28.2207 10.0817V15.0857"
                  stroke="#B3B3B3"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M21.3229 27.2776L26.3268 27.2776C27.3728 27.2776 28.2207 26.4297 28.2207 25.3837V20.3797"
                  stroke="#B3B3B3"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
